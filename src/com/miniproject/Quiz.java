...
public class Quiz {
	...
	public  void getQuizTest(String name) {
		Question q1 = new Question("1.Who is founder of java?", "a.Van Rossum", "b.James Gosling", "c.Dennis Ritchie",
				"d.Bjarne Stroustrup");
		Question q2 = new Question("2.When java was invented?", "a.1995", "b.1996", "c.1918", "d.1999");
		Question q3 = new Question("3.How many pillars of Oops concept?", "a.3", "b.2", "c.5", "d.4");
		Question q4 = new Question("4.How many methods in object class?", "a.13", "b.12", "c.11", "d.15");
		Question q5 = new Question("5.String is the class that represents sequence of……", "a.Object", "b.Character",
				"c.Class", "d.Array");
		Question q6 = new Question("6.Number of primitive data types in java are?", "a.6", "b.7", "c.8", "d.9");
		Question q7 = new Question("7.What is size of float and double in java?", "a.32 & 64", "b.32 & 32", "c.64 & 64",
				"d.64 & 32");
		Question q8 = new Question("8.Array in java are…", "a.Object reference", "b.Objects", "c.Primitive data type",
				"d.None");
		Question q9 = new Question("9.CompareTo() returns", "a.True", "b.False", "c.An int value", "d.None");
		Question q10 = new Question("10.Total constructor string class have?", "a.3", "b.7", "c.13", "d.20");
